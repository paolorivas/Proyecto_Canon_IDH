...
#Revisión de variables
  #1.- dataset1_distritos extraccion minera

      str(dataset1_distritos.extraccion.minera)
      summary(dataset1_distritos.extraccion.minera)
      ...
      #Revisión de las obs que no cuentan con transferencias de canon minero.
          ...
          #1.1.- Mostrar obs NA (Subset que recolecta los NA), para identificar cuáles son los distritos
                  ...
                  dataset1_distritos.extraccion.minera_evidencia <- dataset1_distritos.extraccion.minera[is.na(dataset1_distritos.extraccion.minera$CANON.MINERO), ]
                  View(dataset1_distritos.extraccion.minera_evidencia)
          ...
          #1.2.- Sabiendo cuáles son los distritos, se procede a eliminarlos. (El símbolo "!" excluye a lo seleccionado)
                 ...
                 dataset1_distritos.extraccion.minera_VF <- dataset1_distritos.extraccion.minera[!is.na(dataset1_distritos.extraccion.minera$CANON.MINERO),]
                 View(dataset1_distritos.extraccion.minera_VF)
                 summary(dataset1_distritos.extraccion.minera_VF)
                 
                #1.2.1.- Comprobar si se eliminaron las obs (filas y columnas)
                 
                        dim(dataset1_distritos.extraccion.minera)
                        dim(dataset1_distritos.extraccion.minera_VF)
  
                        
   #2.- dataset2_distritos mineria superficial
                        
      str(dataset2_distritos.mineria.superficial)
        summary(dataset2_distritos.mineria.superficial)
      ...
      #Revisión de las obs que no cuentan con transferencias de canon minero.
          ...
          #2.1.- Mostrar obs NA (Subset que recolecta los NA), para identificar cuáles son los distritos
                  ...
                  dataset2_distritos.mineria.superficial_evidencia <- dataset2_distritos.mineria.superficial[is.na(dataset2_distritos.mineria.superficial$CANON.MINERO), ]
                  View(dataset2_distritos.mineria.superficial_evidencia)
          ...
          #2.2.- Sabiendo cuáles son los distritos, se procede a eliminarlos. (El símbolo "!" excluye a lo seleccionado)
                 ...
                 dataset2_distritos.mineria.superficial_VF <- dataset2_distritos.mineria.superficial[!is.na(dataset2_distritos.mineria.superficial$CANON.MINERO),]
                 View(dataset2_distritos.mineria.superficial_VF)
                 summary(dataset2_distritos.mineria.superficial_VF)
                 
                #2.2.1.- Comprobar si se eliminaron las obs (filas y columnas)
                 
                        dim(dataset2_distritos.mineria.superficial)
                        dim(dataset2_distritos.mineria.superficial_VF)


   #3.- dataset3_distritos no mineria superficial
                        
      str(dataset3_distritos.no.mineria.superficial)
      summary(dataset3_distritos.no.mineria.superficial)
      ...
      #Revisión de las obs que no cuentan con transferencias de canon minero.
          ...
          #3.1.- Mostrar obs NA (Subset que recolecta los NA), para identificar cuáles son los distritos
                  ...
                  dataset3_distritos.no.mineria.superficial_evidencia <- dataset3_distritos.no.mineria.superficial[is.na(dataset3_distritos.no.mineria.superficial$CANON.MINERO), ]
                  View(dataset3_distritos.no.mineria.superficial_evidencia)
          ...
          #3.2.- Sabiendo cuáles son los distritos, se procede a eliminarlos. (El símbolo "!" excluye a lo seleccionado)
                 ...
                 dataset3_distritos.no.mineria.superficial_VF <- dataset3_distritos.no.mineria.superficial[!is.na(dataset3_distritos.no.mineria.superficial$CANON.MINERO),]
                 View(dataset3_distritos.no.mineria.superficial_VF)
                 summary(dataset3_distritos.no.mineria.superficial_VF)
                 
                #3.2.1.- Comprobar si se eliminaron las obs (filas y columnas)
                 
                        dim(dataset3_distritos.no.mineria.superficial)
                        dim(dataset3_distritos.no.mineria.superficial_VF)
                      
                        
#TRANSFORMANDO CANON MINERO DE SOLES A MILLONES DE SOLES
     #1.- Dataset1
          CANON.MINERO.M <- dataset1_distritos.extraccion.minera_VF$CANON.MINERO/1000000
          dataset1_distritos.extraccion.minera_VF <- cbind(dataset1_distritos.extraccion.minera_VF, CANON.MINERO.M)
            View(dataset1_distritos.extraccion.minera_VF)
            
     #2.- Dataset2
          CANON.MINERO.M <- dataset2_distritos.mineria.superficial_VF$CANON.MINERO/1000000
          dataset2_distritos.mineria.superficial_VF <- cbind(dataset2_distritos.mineria.superficial_VF, CANON.MINERO.M)
            View(dataset2_distritos.mineria.superficial_VF)

            
     #3.- Dataset3
          CANON.MINERO.M <- dataset3_distritos.no.mineria.superficial_VF$CANON.MINERO/1000000
          dataset3_distritos.no.mineria.superficial_VF <- cbind(dataset3_distritos.no.mineria.superficial_VF, CANON.MINERO.M)
            View(dataset3_distritos.no.mineria.superficial_VF)
            
#CREANDO UNA NUEVA VARIABLE PARA CODIFICAR DEPARTAMENTOS POR REGIONES
   #Dataset1
    table(dataset1_distritos.extraccion.minera_VF$REGION)
    
    dataset1_distritos.extraccion.minera_VF$REGION_2 <- recode(dataset1_distritos.extraccion.minera_VF$REGION,
                                                               "AMAZONAS" = "SELVA" , 
                                                               "ANCASH" = "SIERRA",  
                                                               "APURIMAC" = "SIERRA",
                                                               "AREQUIPA" = "SIERRA" , 
    ...
    #Dataset2
    table(dataset2_distritos.mineria.superficial_VF$REGION)
    
    dataset2_distritos.mineria.superficial_VF$REGION_2 <- recode(dataset2_distritos.mineria.superficial_VF$REGION,
                                                               "ANCASH" = "SIERRA",  
                                                               "APURIMAC" = "SIERRA", 
                                                               "AREQUIPA" = "SIERRA",
                                                               "AYACUCHO" =  "SIERRA" , 
    ...
    #Dataset3
     ...
     table(dataset3_distritos.no.mineria.superficial_VF$REGION)
    
    dataset3_distritos.no.mineria.superficial_VF$REGION_2 <- recode(dataset3_distritos.no.mineria.superficial_VF$REGION,
                                                               "AMAZONAS" = "SELVA" , 
                                                               "ANCASH" = "SIERRA", 
                                                               "AREQUIPA" = "SIERRA", 
                                                               "AYACUCHO" =  "SIERRA" , 
...
##ESTADÍSTICA
  #1.- Mediana, media y moda
      # Dataset1
        summary(dataset1_distritos.extraccion.minera_VF)
        median(dataset1_distritos.extraccion.minera_VF$CANON.MINERO)
        mean(dataset1_distritos.extraccion.minera_VF$CANON.MINERO)
...
#DATASET1
        ...
        ggplot(dataset1_distritos.extraccion.minera_VF, aes(x=AÑO, y=CANON.MINERO.M, fill=REGION_2)) + geom_bar(stat = "identity")   
   
          #1.2 Dispersión de IDH - Canon minero por año, con etiquetas del distrito - SCATTER SMALL MULTIPLES
          dataset1_distritos.extraccion.minera_VF %>%
            ggplot(aes(x=CANON.MINERO.M, y=IDH, color=REGION_2)) +
            geom_point(size=1) +
          ...
          #1.3.1 Evolución de las transferencias de la sierra, por región
          dataset1_distritos.extraccion.minera_VF %>%
            filter(REGION_2=="SIERRA") %>%
            ggplot(aes(x=AÑO, y=CANON.MINERO.M, fill=REGION)) + geom_bar(stat = "identity")
          
          "Ancash, departamento que más transferencias ha recibido durante todo el periodo"
        ...
        ggplot(aes(x=AÑO, y=IDH, fill=DISTRITO, color=DISTRITO, size=CANON.MINERO.M)) +
          ...
          "Cajamarca, segundo departamento con mayores transferencias"
        ...
        ggplot(aes(x=AÑO, y=IDH, fill=DISTRITO, color=DISTRITO, size=CANON.MINERO.M)) +
          ...
          #geom_text(aes(label=UBIGEO), nudge_x = 0.02, nudge_y = 0.02, check_overlap =T)       
           ...
           "Moquegua, segundo departamento con mayores transferencias"
...
- El gráfico scatterplot evidencia que, de la lista de distritos que realizan alguna actividad minera, la gran mayoría se concentra en aquellos que reciben menos por el canon minero. Sin embargo, existen ciertos distritos que reciben grandes cantidades. Ello permite visualizar el esquema desigual de distribución, pues San Marcos - Áncash (Minería superficial) recibió más de 200 millones de soles en el 2007, mientras que Manuel Anatonio Mesones Muro (Lambayeque) recibió 2.9 soles, en el mismo año. (Valorización de la producción según método de explotación).

- Si todos los distritos son considerados productores por qué hay algunos que reciben cifras exorbitantes.
  Ancash es el departamento más transferencias ha recibido en el dominio de la sierra, si se observa a sus distritos se evidencia lo siguiente:
    - El distrito que más transferencias recibió fue San Marcos (Minería Superficial) y el que menos recibió fue Parihuanca (Minería no metálica). Ello llevaría a pensar que los métodos de explotación podrían ser la razón de la diferencia pues minería superficial extrae minerales como cobre, molibdeno, zinc, etc. mientras que en no metálica  está calcita. (Valorización de la producción según método de explotación). En cuanto al IDH, si bien durante un breve periodo tenían cifras similares, a partir del 2012, San Marcos incrementa su IDH de manera considerable. (Qué incrementa el IDH, ingresos, años de educación, esperanza de vida)
    - Si se compara distritos de un mismo método de explotación, sería Jangas y San Marcos. En dicho caso la diferencia recaría en el tamaño de la empresa, pues es Barrick Misquichilca y Antamina. 

- Si se observa el segundo departamento con mayores transferencias, Cajamarca, se ve lo siguiente:
    - Es Cajamarca (Minería superficial) el distrito que más transferencias recibe.Asimismo, dentro de dicho distrito está Yanacocha extrayendo oro y cobre. Mientras que Sexi (Minería no metálica) es la que menos recibe. En el distrito mencionado radica Cementos Pcasmayo extrayendo puzolana. En cuanto al IDH, durante un tiempo hubo una brecha en ambas cifras. En el 2017, pese a la gran diferencia en el monto transferido, ambos distritos tuvieron casi el mismo IDH. 
    ...
    - Cautiluc (minería superficial) que extrae oro y plata, no recibe muchas transferencias. Este distrito resalta porque durante el periodo considerado el IDH solo mejoró un 10%.
    
- Moquegua , de la costa, es el tercer departamento con mas transferencias recibidas durante el periodo considerado, muestra lo siguiente: 
...
#DATASET2
      #MOSTRAR QUE LOS DISTRITOS CONSIDERADOS SOLO TIENEN UN MÉTODO DE EXPLOTACIÓN Y NO 
       ...
       "CUADRO QUE MUESTRE LAS TRASNFERENCIAS RECIBIDAS POR AMBOS DISTRITOS EN COMPARACIÓN CON EL TOTAL"
        ...
        ggplot(dataset2_distritos.mineria.superficial_VF, aes(x=AÑO, y=CANON.MINERO.M, fill=REGION_2)) + geom_bar(stat = "identity")

      
        #2.2 Dispersión de IDH - Canon minero por año, con etiquetas del distrito - SCATTER SMALL MULTIPLES
          dataset2_distritos.mineria.superficial_VF %>%
            ggplot(aes(x=CANON.MINERO.M, y=IDH, color=REGION_2)) +
            geom_point(size=1) +
            #geom_text(aes(label=DISTRITO), 
                       #nudge_x = 0.02, nudge_y = 0.02, check_overlap =T, size = 1.5)+
        ...
        ggplot(aes(x=AÑO, y=IDH, fill=UBIGEO, color=REGION_2, size=CANON.MINERO.M)) +
          geom_point() #+
          #geom_text(aes(label=UBIGEO), nudge_x = 0.02, nudge_y = 0.02, check_overlap =T)  
...
- Cuando se observa la relación IDH/canon resalta que:
    - Pese a que, San Marcos (Ancash) es el que más transferencias recibe, es el decimosexto en la clasificación del IDH, promedio del periodo . Mientras que Ilabaya (Tacna), segundo con mayores transferencias, es el que lidera dicha clasificación.
...
#DATASET3
      ...
      #MOSTRAR QUE LOS DISTRITOS CONSIDERADOS SOLO TIENEN UN MÉTODO DE EXPLOTACIÓN Y NO 
       ...
       "CUADRO QUE MUESTRE LAS TRASNFERENCIAS RECIBIDAS POR AMBOS DISTRITOS EN COMPARACIÓN CON EL TOTAL"
        ...
        #2.1 Evolución de las transferencias de canon minero según dominio natural - BARPLOT
        ggplot(dataset3_distritos.no.mineria.superficial_VF, aes(x=AÑO, y=CANON.MINERO.M, fill=REGION_2)) + geom_bar(stat = "identity") 
        
                
        #2.2 Dispersión de IDH - Canon minero por año, con etiquetas del distrito - SCATTER SMALL MULTIPLES
          dataset3_distritos.no.mineria.superficial_VF %>%
